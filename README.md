...
Pasos:
 ...
 - Haz clic en el ícono de lupa 🔍 en la barra izquierda (Model search)
 - Instalare este en mi caso `https://huggingface.co/Qwen/Qwen2.5-0.5B-Instruct-GGUF`, pero si tienes más RAM puedes descargar otro.
